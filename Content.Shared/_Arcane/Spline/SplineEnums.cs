...
using Content.Shared._Arcane.Spline.CatmullRom;
using Content.Shared._Arcane.Spline.CubicBezier;
using Content.Shared._Arcane.Spline.Linear;
using Vector4 = System.Numerics.Vector4;

namespace Content.Shared._Arcane.Spline;
