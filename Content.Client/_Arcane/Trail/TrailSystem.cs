...
namespace Content.Client._Arcane.Trail;
...
public sealed class TrailSystem : EntitySystem
{
    ...
    {
        if (comp.CreationMethod != SegmentCreationMethod.OnMove || _gameTiming.InPrediction)
            return;
    ...
    public override void FrameUpdate(float frameTime)
    {
        ...
        {
            if (comp.CreationMethod == SegmentCreationMethod.OnFrameUpdate)
