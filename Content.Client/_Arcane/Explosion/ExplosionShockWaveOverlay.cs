...
using Content.Shared._Arcane.Explosion;
using Robust.Client.Graphics;
using Robust.Shared.Configuration;
using Robust.Shared.Enums;
using Robust.Shared.Prototypes;

namespace Content.Client._Arcane.Explosion;
...
public sealed class ExplosionShockWaveOverlay : Overlay
{
    ...
    public ExplosionShockWaveOverlay()
    {
        ...
        // _cfg.OnValueChanged(ACCVars.ShowExplosionShockWave, val => _enabled = val, true);
    }
